...
[data-toggle="tooltip"] {
    ...
    <div class="assignments-header">
        <h1 class="assignments-title">Asignaciones</h1>
        <button type="button" class="btn btn-new-assignment" id="btnNuevo">
            Nuevo
        </button>
    </div>
                ...
                "columns": [
                    {
                        ...
                        "render": function(data) {
                            return `<span class="assignment-zone">${data}</span>`;
                        }
                    },
                    {
                        "data": "vehicle_name",
                        "render": function(data) {
                            return `<span class="assignment-vehicle">${data}</span>`;
                        }
                    },
                    {
                        "data": "shift_name",
                        "render": function(data, type, row) {
                            let className = row.shift_name.toLowerCase().replace(/\s/g, '-');
                            return `<span class="assignment-shift ${className}">${data}</span>`;
                        }
                    },
                    {
                        "data": "empleados",
                        "render": function(data) {
                            return `<span class="assignment-employees">${data}</span>`;
                        }
                    },
                    {
                        "data": "edit",
                    ...
                    },
                    {
                        ...
                        "width": "4%",
                        "render": function(data, type, row) {
                            return `<form class="frmDelete d-inline" action="{{ route('admin.zoneassignments.destroy', 'id') }}".replace('id', ${row.id}) method="POST">
                                @csrf
                                @method('DELETE')
