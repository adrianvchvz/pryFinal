...
<script>
            ...
            "columns": [
                {
                    ...
                    "render": function(data, type, row) {
                        return '<span class="employee-name">' + data + '</span>';
                    }
                },
                {
                    "data": "start_date",
                    "render": function(data, type, row) {
                        return '<span class="date-range">' + data + '</span>';
                    }
                },
                {
                    "data": "end_date",
                ...
                },
                {
                    "data": "days",
                    "render": function(data, type, row) {
                        return '<span class="days-count">' + data + '</span>';
                    }
                },
                {
                    "data": "pending_days",
                    "render": function(data, type, row) {
                        return '<span class="pending-days">' + data + '</span>';
                    }
                },
                {
                    "data": "description",
    ...
    $('#btnNuevo').click(function() {
        $.ajax({
            ...
            success: function(response) {
                $('.modal-title').html("Nuevas vacaciones");
    ...
    $(document).on('click', '.btnEditar', function() {
        ...
        $.ajax({
            ...
            type: "GET",
            success: function(response) {
                $('.modal-title').html("Editar vacaciones");
                $('#ModalCenter .modal-body').html(response);
                $('#ModalCenter').modal('show');
