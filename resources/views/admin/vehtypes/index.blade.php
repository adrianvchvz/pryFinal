...
.vehicle-types-title::before {
    margin-right: 12px;
    font-size: 1.3rem;
}

.btn-new-vehicle-type {
...
<script>
    $(document).ready(function() {
        $('#datatable').DataTable({
            ...
            "ajax": "{{ route('admin.vehtypes.index') }}",
            "columns": [
                {
                    "data": "name",
    ...
    $('#btnNuevo').click(function() {
        $.ajax({
            url: "{{ route('admin.vehtypes.create') }}",
            type: "GET",
            success: function(response) {
                $('.modal-title').html("Nuevo tipo de vehículo");
    ...
    $(document).on('click', '.btnEditar', function() {
        var id = $(this).attr("id");
        $.ajax({
            url: "{{ route('admin.vehtypes.edit', 'id') }}".replace('id', id),
            type: "GET",
            success: function(response) {
