...
[data-toggle="tooltip"] {
    ...
    <div class="schedules-header">
        <h1 class="schedules-title">Programación</h1>
        <button type="button" class="btn btn-new-schedule" id="btnNuevo">
           Nuevo
        </button>
    </div>
            ...
            $('#datatable').DataTable({
                ...
                "columns": [{
                        ...
                        "render": function(data) {
                            return `<span class="schedule-name">${data}</span>`;
                        }
                    },
                    {
                        "data": "start_date",
                        "render": function(data) {
                            return `<span class="schedule-date">${data}</span>`;
                        }
                    },
                    {
                        "data": "end_date",
